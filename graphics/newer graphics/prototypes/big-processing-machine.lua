...
data:extend({
	{
		...
		icon = "__hardCrafting__/graphics/icons/big-processing-machine_icon.png",
...
overwriteContent(processer, {
	...
	animation = {
		filename = "__hardCrafting__/graphics/entity/animation/big-processing-machine_animation.png",
		priority = "high",
		width = 186,
		height = 160,
		frame_count = 4,
...
data:extend({
  {
    type = "technology",
    name = "big-processing-machine",
    icon = "__hardCrafting__/graphics/technology/big-processing-machine_tech.png",
    icon_size = 128,
